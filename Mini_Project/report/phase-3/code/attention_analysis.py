...
LANG_CONFIG = {
    "telugu": dict(
        ...
        finetuned_ckpt=ROOT / "telugu/model/outputs/finetune_checkpoints/checkpoint_best.pt",
    ...
    "bhojpuri": dict(
        ...
        finetuned_ckpt=ROOT / "bhojpuri/model/outputs/finetune_checkpoints/checkpoint_best.pt",
