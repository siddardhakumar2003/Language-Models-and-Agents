...
\subsection{Token Progress Toward 500M Target}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../plot/plot_token_progress.png}
    \caption{
        Progress toward 500M token target. Telugu: 4,421.9M tokens (884.4\% complete, exceeds target by 8.8x).
        Bhojpuri: 291.7M tokens (58.3\% complete, 2.1x expansion from Phase 1). Target achieved for Telugu;
        Bhojpuri approaching target with Phase 3 English→Bhojpuri translation pipeline.
    }
    \label{fig:token_progress}
\end{figure}
...
\begin{table}[H]
    ...
    Bhojpuri Unicode-level & 4.348 & 0.0000\% & 31,258 \\
    Bhojpuri WordPiece & 3.95 & 0.0002\% & 11,391,403 \\
    \hline
    \end{tabular}
