"""
Bhojpuri Transformer Pretraining Script
...
class Trainer:
    def __init__(self, model, train_loader, val_loader, device, config, log_dir="logs"):
        ...
        self.log_file = self.log_dir / "training_bhojpuri.log"
...
def main(args):
    ...
    print(f"\n✓ Initialized BhojpuriTransformer with {model.count_parameters():,} parameters")
