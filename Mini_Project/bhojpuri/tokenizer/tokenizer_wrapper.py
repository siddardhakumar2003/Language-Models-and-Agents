"""
Bhojpuri WordPiece Tokenizer Wrapper
Loads pre-trained WordPiece tokenizer and exposes encode/decode/vocab_size.
Note: [CLS] and [SEP] are mapped to BOS and EOS roles for language generation.
"""
...
class BhojpuriTokenizer:
    def __init__(self, config_path=None, tokenizer_path=None):
        ...
        if tokenizer_path is None:
            tokenizer_rel = self.config.get("tokenizer_path", "full_wordPiece_level/bhojpuri_wp_tokenizer.json")
