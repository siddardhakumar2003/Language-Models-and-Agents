...
Safety:
    ...
    - Verifies final bhoj.txt exists and has content
...
def main():
    ...
    if not is_valid:
        logger.error("\nCannot proceed: bhoj.txt is not valid")
    ...
    logger.info(f"✓ Preserved: bhoj.txt, train/val/test/")
    logger.info("=" * 70)
