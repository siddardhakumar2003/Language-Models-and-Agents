"""
Telugu Decoder-Only Transformer Language Model (from scratch).
...
class TeluguTransformer(nn.Module):
    """
    Decoder-only Transformer LM for Telugu.
...
if __name__ == "__main__":
    print("Testing TeluguTransformer...")
